             ...
             @foreach ($berita as $item)
              <tr>
                ...
                <td class="align-middle text-center">
                  <a href="/naili-administrator/berita/{{ $item->id }}/edit"><span class="badge badge-sm bg-gradient-warning">Edit</span></a>
                  <form action="/naili-administrator/berita/{{ $item->id }}" method="post" style="display: inline">
                    @method('delete')
                    @csrf
                    <button class="btn badge badge-sm bg-gradient-danger" onclick="return confirm('Yakin menghapus berita?')" >Hapus</button>
                  </form>
                </td>
              </tr>
              @endforeach
