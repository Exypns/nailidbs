...
<div class="card-body">
    ...
    <div class="modal-body">
        ...
        <div class="input-group input-group-outline mb-3">
            <input type="text" class="form-control" name="judul" required value="{{ $berita->judul }}">
        </div>
        @error('judul')
        ...
        @if ($berita->image)    
            <img src="{{ asset('storage/' . $berita->image) }}" class="img-preview mb-2" style="width: 30%; display:block">
        @else
