    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-warning shadow-primary border-radius-lg pt-4 pb-3" style="display: flex; gap: 10px">
          ...
          <a href="/naili-administrator/promo/tambah-promo"><span class="badge badge-sm bg-gradient-success">Tambah Promo</span></a>
        </div>
      </div>
      <form action="/naili-administrator/promo">
             ...
             @foreach ($promo as $item)
              <tr>
                ...
                <td class="align-middle text-center">
                  <a href="/naili-administrator/promo/{{ $item->id }}/edit"><span class="badge badge-sm bg-gradient-warning">Edit</span></a>
                  <form action="/naili-administrator/promo/{{ $item->id }}" method="post" style="display: inline">
                    @method('delete')
                    @csrf
                    <button class="btn badge badge-sm bg-gradient-danger" onclick="return confirm('Yakin menghapus promo?')" >Hapus</button>
                  </form>
                </td>
              </tr>
              @endforeach
