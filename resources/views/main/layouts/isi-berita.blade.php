...
@section('content')
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('main-layouts-assets/css/isi-berita.css') }}"/>
    </head>
<body>
    <section>
        ...
        <div class="judul-berita">
            <img src="gambar/BERITAkosong.png" alt="">
            <h2>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h2>
        <div class="pembungkusdata">
            <div class="databerita">
            <img src="{{ asset('icons/calender.png') }}" alt="img" class="icon">
                <p class="icon">17-Jan-2024 08:32:5</p> 
            </div>
             <div class="databerita">
             <img src="{{ asset('icons/user.png') }}" alt="img" class="icon">
                <p class="icon">  
                    By Administrator
                </p>
