...
<section>
    <div class="all-profil">
        ...
        <div class="Kegiatan-img-container">
          <img class="Kegiatan-img" src="{{ asset('main-layouts-assets/images/garis.png') }}">
        </div>
        
        <div class="isi-sejarah">
            <div class="container-sejarah1">
                <img class="gambarsejarah1" src="{{ asset('main-layouts-assets/images/sejarah1.png') }}" alt="">
            ...
            <div class="container-sejarah2">
                <img class="gambarsejarah1" src="{{ asset('main-layouts-assets/images/sejarah2.png') }}" alt="">
        ...
        <div class="isi-visimisi">
            <div class="container-visi">
                <h3>VISI</h3>
                <div class="sub-visi">
                     <img src="{{ asset('main-layouts-assets/images/visi.png') }}" alt="">
            ...
            <div class="container-misi">
                ...
                <div class="isi-container-misi">
                    <div class="sub-misi">
                        <img src="{{ asset('main-layouts-assets/images/MISI1.png') }}" alt="">
                    ...
                    <div class="sub-misi">
                        <img src="{{ asset('main-layouts-assets/images/MISI2.png') }}" alt="">
                        <p>Menjunjung tinggi nilai nilai kemanusiaan serta mengutamakan kepuasan pelanggan dan karyawan 
                        </p>
                    </div>
                    <div class="sub-misi">
                        <img src="{{ asset('main-layouts-assets/images/MISI3.png') }}" alt="">
        ...
        <div class="Kegiatan-img-container">
          <img class="Kegiatan-img" src="{{ asset('main-layouts-assets/images/garis.png') }}">
            ...
            <div class="container-nilai">
                    <div class="card">
                        <img src="{{ asset('main-layouts-assets/images/nilai.png') }}" alt="">
                        <p>Ramah</p>
                    </div>
